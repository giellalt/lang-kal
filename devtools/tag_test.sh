...
cat src/fst/morphology/stems/*lexc |cut -d '!' -f1 |grep ';.*;'| ggrep -E -v '(SCND|THRD|FRTH|FFTH|ACRO|anl)' | ggrep -E -v '%;' | ggrep -E -v '; arabiskeefterkomma ;'
