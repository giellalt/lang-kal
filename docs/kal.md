 ...
 * **+GUNNAIR +GIARTUR +GUNNAIR +GIARTUR +INNAR** = 
 ...
 * **+JAAR +QQU +JAAR +QQU +GALUAR +JAAR +QQU +NAVIAR +NNGIT +JAAR +QQU +SIMA +JAAR +QQU +SIMA +GALUAR** = 
 * **+JAAR +SIMA** = 
 ...
 * **+KULAAR +VALLAAR** = 
 * **+KULLAK +KULLAK +SUAQ** = 
 * **+KULUP +KULUP +QE +KULUP +TUAR +KULUP +TUAR +SSA +KULUP +TUAR +SSA +NIR** = 
 * **+KULUUQ** = 
 * **+KUQ +KUQ +NNGUAQ** = 
 ...
 * **+LLUAR +USAR** =  soorlu uani "nalulluaasarpara"   
 * **+LLUAR +VIP** = 
 * **+LLUAR +VISSUR** = 
 * **+LLUINNAR** = 
 * **+LLUINNAR +GALUAR** = 
 ...
 * **+NAR +GUNNAIR** = 
 * **+NAR +INNAR +NAR +INNAR +GALUAR +NAR +INNAR +GALUAR +RIAR +NAR +INNAR +GUNAR +NAR +INNAR +GUSUP +NAR +INNAR +GUSUP +GALUAR +NAR +INNAR +LIR +NAR +INNAR +LIR +SSA +NAR +INNAR +NGAJAP +NAR +INNAR +NGAJAP +TAR +NAR +INNAR +NIAR +NAR +INNAR +NIAR +NNGIT +NAR +INNAR +NNGIT +NAR +INNAR +NNGIT +GALUAR +NAR +INNAR +NNGIT +GALUAR +NIR +NAR +INNAR +NNGIT +NIR +NAR +INNAR +QE +NAR +INNAR +QQU +NAR +INNAR +RIAR +NAR +INNAR +SIMA +NAR +INNAR +SIMA +NIR +NAR +INNAR +SINNAA +NAR +INNAR +SINNAA +NNGIT +NAR +INNAR +SSA +NAR +INNAR +TAR +NAR +INNAR +TAR +SIMA +NIR +NAR +INNAR +TAR +SINNAA +NAR +INNAR +TARIAQAR +NAR +INNAR +TARIAQAR +GALLAR +NAR +INNAR +TARIAQAR +GALUAR +NAR +INNAR +TARIAQAR +GUNAR +NAR +INNAR +TARIAQAR +LIR +NAR +INNAR +TARIAQAR +NNGIT +NAR +INNAR +TARIAQAR +SIMA +NAR +INNAR +TARIAQAR +SINNAA +NAR +INNAR +TARIAQAR +SSA +NAR +INNAR +TARIAQAR +TAR +NAR +INNAR +VIP +NAR +INNAR +VIP +TAR +NAR +INNAR +VIP +TAR +SIMA** = 
 ...
 * **+NIAR +PILUP** = 
 * **+NIAR +QE** = 
 * **+NIAR +QQAAR +NIAR +QQAAR +NNGIT +NIAR +QQAAR +NNGIT +VIP +NIAR +QQAAR +SSA** = 
 ...
 * **+NIR** =  20100227 Only followed by inflection (XIiX_fleksiver, XIiPX_fleksiver samt iGaq_NIR) (PL)   
 * **+NIRAR** = 
 * **+NIRAR +GALUAR** = 
 * **+NIRAR +TAR** = 
 * **+NIRAR +TAR +RIAR** = 
 ...
 * **+NNGIT +KUJUP +TAR** = 
 * **+NNGIT +LI** = 
 * **+NNGIT +LIR +NNGIT +LIR +TUR +NNGIT +LIR +TUR +RIAR** = 
 ...
 * **+QQAAR +NIAR +QQAAR +NIAR +NNGIT +QQAAR +NIAR +RIAR +QQAAR +NIAR +SSA** = 
 * **+QQAAR +NIUP** = 
 * **+QQAAR +RIAR** = 
 * **+QQAAR +SIMA +QQAAR +SIMA +LIR +QQAAR +SIMA +NNGIT +QQAAR +SIMA +SSA +NNGIT +GALUAR** = 
 * **+QQAAR +SSA +QQAAR +SSA +NNGIT +QQAAR +SSA +NNGIT +NIR** = 
 * **+QQAAR +TAR +QQAAR +TARIAQAR** = 
 * **+QQAAR +TIP +QQAAR +TIP +HTR +QQAAR +TIP +NIQAR** = 
 * **+QQAJAA** = 
 * **+QQAJAA +INNAR** = 
 * **+QQAJAA +INNAR +LIR** = 
 * **+QQAJAA +INNAR +VIP** = 
 ...
 * **+QQAJAR +VIP** = 
 * **+QQAMMIQ** = 
 * **+QQAMMIR +QQAMMIR +SIMA** = 
 * **+QQAR** = 
 * **+QQAR +RIAR** = 
 * **+QQAR +TAR +QQAR +TAR +SIMA** = 
 * **+QQAR +VIP** = 
 * **+QQARTUR** = 
 * **+QQATAR** = 
 * **+QQATUR** = 
 ...
 * **+QQIP** = 
 * **+QQIP +GALUAR** = 
 * **+QQIP +GUMA +QQIP +GUMA +NNGIT** = 
 * **+QQIP +GUMAAR +QQIP +GUMAAR +NIR** = 
 * **+QQIP +GUNNAR +NNGIT** = 
 * **+QQIP +GUSUP +QQIP +GUSUP +GALUAR +QQIP +GUSUP +GALUAR +QE +QQIP +GUSUP +GUNNAIR +QQIP +GUSUP +GUNNAIR +GALUAR +QQIP +GUSUP +NNGIT +QQIP +GUSUP +LIR +QQIP +GUSUP +LIR +GALUAR +QQIP +GUSUP +LIR +GALUAR +NNGIT +QQIP +GUSUP +LIR +NIKUU +QQIP +GUSUP +LIR +NIKUU +GUNAR +QQIP +GUSUP +LIR +NIKUU +GUNAR +NNGIT +QQIP +GUSUP +LIR +NIKUU +NNGIT** = 
 * **+QQIP +INNAR +QQIP +INNAR +TAR +QQIP +INNAR +TARIAQAR** = 
 * **+QQIP +LAAR +QQIP +LAAR +GUSUP** = 
 * **+QQIP +LIR +QQIP +LIR +GALUAR +QQIP +LIR +SIMA +QQIP +LIR +SINNAA +QQIP +LIR +SSA** = 
 * **+QQIP +NAVIAR +NNGIT** = 
 * **+QQIP +NGAJAP +QQIP +NGAJAP +LIR** = 
 * **+QQIP +NIAR +QQIP +NIAR +GALUAR +QQIP +NIAR +NNGIT +QQIP +NIAR +TAR** = 
 * **+QQIP +NNGIT +QQIP +NNGIT +LUINNAR +QQIP +NNGIT +RIAR +QQIP +NNGIT +TUUR** = 
 * **+QQIP +PALLAP +QQIP +PALLAP +TARIAQAR** = 
 * **+QQIP +QINA** = 
 * **+QQIP +RIAR +QQIP +RIIR** = 
 * **+QQIP +SIMA +QQIP +SIMA +NNGIT +QQIP +SIMA +NNGIT +GALUAR** = 
 * **+QQIP +SINNAA +QQIP +SINNAA +GUMA +QQIP +SINNAA +GUNNAIR +QQIP +SINNAA +NNGIT +LLUINNAR +QQIP +SINNAA +SSA +QQIP +SINNAA +TAR +QQIP +SINNAA +TAR +NNGIT +QQIP +SINNAA +TUQ +U +GALUAR** = 
 * **+QQIP +SSA +QQIP +SSA +NIR +QQIP +SSA +NGA +QQIP +SSA +NNGIT** = 
 * **+QQIP +TARIAQAR +QQIP +TARIAQAR +NIR +QQIP +TARIAQAR +NNGIT** = 
 * **+QQIP +TAR +QQIP +TAR +LIR +QQIP +TAR +SIMA +QQIP +TAR +SIMA +SINNAA +QQIP +TAR +SSA** = 
 * **+QQIP +TSIAR +QQIP +TSIAR +GUMA +QQIP +TSIAR +GUMA +GALUAR +QQIP +TSIAR +GUMA +GALUAR +QE** = 
 * **+QQISSAAQ** = 
 * **+QQISSAAR** = 
 * **+QQISSAAR +GUMA** = 
 * **+QQISSAAR +NIQAR +QQISSAAR +NIQAR +SIMA +QQISSAAR +NIQAR +SINNAA** = 
 * **+QQISSAAR +NNGIT** = 
 * **+QQISSAAR +QQU +QQISSAAR +QQU +INNAR +QQISSAAR +QQU +RIAR** = 
 * **+QQISSAAR +RIAR** = 
 * **+QQISSAAR +RIIR** = 
 * **+QQISSAAR +SIMA** = 
 * **+QQISSAAR +SINNAA** = 
 * **+QQISSAAR +SSA** = 
 * **+QQISSAAR +TARIAQAR +QQISSAAR +TARIAQAR +TAR** = 
 * **+QQISSAAR +TAR +QQISSAAR +TAR +NIAR +QQISSAAR +TAR +NIAR +GUMAAR** = 
 * **+QQISSAAR +UTIGE** = 
 * **+QQU** = 
 * **+QQU +GALUAR** = 
 * **+QQU +GIARTUR +QQU +GIARTUR +NIAR +QQU +GIARTUR +QQU +QQU +GIARTUR +TIP** = 
 * **+QQU +GUNAR** = 
 * **+QQU +GUNNAIR** = 
 * **+QQU +HTR** = 
 * **+QQU +NIAR +QQU +NIAR +NIR** = 
 * **+QQU +NIQAR +QQU +NIQAR +NNGIT** = 
 * **+QQU +NNGIT +QQU +NNGIT +LUINNAR +QQU +NNGIT +VIP** = 
 * **+QQU +QE** = 
 * **+QQU +SAAR** = 
 * **+QQU +SIMA** = 
 * **+QQU +SINNAA +QQU +SINNAA +NNGIT** = 
 * **+QQU +SSA +QQU +SSA +NNGIT** = 
 * **+QQU +TAR** = 
 * **+QQU +TIGE +QQU +TIGE +QQIP +QQU +TIGE +QQISSAAR +QQU +TIGE +QQISSAAR +TARIAQAR +QQU +TIGE +QQISSAAR +TARIAQAR +TAR** = 
 * **+QQUSAAR** =  sættes kun på transitive stammer +QQUSAAR +SURE +QQUSAAR +SURE +QINA   
 * **+QQURTU** =  verb-kal-imut ikkuppoq qaqutigoornermit soorlu nioqqortuvoq iseqqortuvoq il il   
 * **+QQURTUUQ** = 
 * **+QQURTUSI** = 
 * **+QQUTE** = 
 * **+QQUUTE** = 
 ...
 * **+RAALLAK** = 
 * **+RAAR** = 
 * **+RALAAQ +NNGUAQ +RALAAQ +SUAQ** = 
 * **+RALAK** = 
 * **+RAR** = 
 * **+RAR +SIMA** = 
 * **+RAR +SSAAR** = 
 * **+RAR +TIP** = 
 * **+RASAAR** =  +nv kun i verb-kal imarasaarpoq   
 * **+RATAR** = 
 * **+RATAR +SIMA +RATAR +SIMA +NIR +RATAR +SIMA +SINNAA +RATAR +SIMA +SINNAA +NIR +RATAR +SIMA +SINNAA +NNGIT +RATAR +SIMA +SINNAA +NNGIT +NIR** = 
 * **+RATAR +SINNAA +RATAR +SINNAA +TAR** = 
 * **+RIAANNAA** = 
 * **+RIAAT** =  Kun ved numeralierne   
 * **+RIANNGUAR** = 
 * **+RIAQ +INNAQ** = 
 * **+RIAR** = 
 * **+RIAR +ALLAP +RIAR +ALLAP +TIP +RIAR +ALLAP +TIP +HTR** = 
 * **+RIAR +GALUAR** = 
 * **+RIAR +GALUAR +SSA +RIAR +GALUAR +SSA +QE** = 
 * **+RIAR +GALUAR +TAR** = 
 * **+RIAR +GUSUP +RIAR +GUSUP +UMMIR** = 
 * **+RIAR +INNAR** = 
 * **+RIAR +LAAR +RIAR +LAAR +GALLAR +RIAR +LAAR +GALLAR +NIAR +RIAR +LAAR +GUNAR +RIAR +LAAR +INNAR +RIAR +LAAR +INNAR +GUNAR +RIAR +LAAR +SIMA +RIAR +LAAR +SSA +RIAR +LAAR +SSA +GALUAR +RIAR +LAAR +SSA +GUNAR** = 
 * **+RIAR +LLAQQIP** = 
 * **+RIAR +LLAARE** = 
 * **+RIAR +LLAR +RIAR +LLAR +GALUAR +RIAR +LLAR +QE** = 
 * **+RIAR +NAVIAR +NNGIT** = 
 * **+RIAR +NIAR +RIAR +NIAR +SSA** = 
 * **+RIAR +NNGIT +RIAR +NNGIT +VIP** = 
 * **+RIAR +NNGUAR** = 
 * **+RIAR +QQIP +RIAR +QQIP +NAVIAR +NNGIT +RIAR +QQIP +NNGIT +RIAR +QQIP +NNGIT +TUUR +RIAR +QQIP +NNGIT +TUUR +SSA +RIAR +QQIP +NNGIT +TUUR +SSA +GALUAR +RIAR +QQIP +SIMA +RIAR +QQIP +SIMA +NNGIT +RIAR +SINNAA +LIR +RIAR +QQIP +SINNAA +LIR +TIP +RIAR +QQIP +SINNAA +NNGIT** = 
 * **+RIAR +RUJUP +RIAR +RUJUP +SUAR +RIAR +RUJUP +SUAR +SIMA** = 
 * **+RIAR +RUTTUR** = 
 * **+RIAR +SIMA +RIAR +SIMA +NNGIT** = 
 * **+RIAR +SINNAAA +RIAR +SINNAA +GUNNAIR +RIAR +SINNAA +GUNNAIR +QQA +RIAR +SINNAA +GUNNAIR +TIP +RIAR +SINNAA +GUNNAIR +GAJUP +TAR +RIAR +SINNAA +NNGIT +RIAR +SINNAA +NNGIT +TAR +INNAR +RIAR +SINNAA +SIMA +RIAR +SINNAA +SIMA +NNGIT +RIAR +SINNAA +SIMA +SSA +RIAR +SINNAA +SIMA +SSA +GALUAR +RIAR +SINNAA +SSA** = 
 * **+RIAR +SINNAA +GUNNAIR +GAJUP +TAR** = 
 * **+RIAR +SSA +RIAR +SSA +NIR +RIAR +SSA +NNGIT +RIAR +SSA +NNGIT +LUINNAR** = 
 * **+RIAR +TAR +RIAR +TAR +GALUAR +RIAR +TAR +NNGIT** = 
 * **+RIAR +TIP** = 
 * **+RIAR +USIQ** = 
 * **+RIAR +UTIGE** = 
 * **+RIATAAR** = 
 * **+RIATAAR +GALUAR** = 
 * **+RIATAAR +GUNAR** = 
 * **+RIATAAR +LIR +RIATAAR +LIR +NGAAR** = 
 * **+RIATAAR +LLAR** = 
 * **+RIATAAR +NAVIAR +NNGIT** = 
 * **+RIATAAR +NGAAR** = 
 * **+RIATAAR +NGAJAP** = 
 * **+RIATAAR +NIKUU** = 
 * **+RIATAAR +NIRAR** = 
 ...
 * **+RIATAAR +QQIP** = 
 * **+RIATAAR +SIMA** = 
 * **+RIATAAR +SINNAA +RIATAAR +SINNAA +TAR** = 
 * **+RIATAAR +TAR** = 
 * **+RIATAAR +TIGE** = 
 * **+RIATAAR +TUUR** = 
 * **+RIATAAR +UTIGE** = 
 ...
 * **+RIIR +GALUAR** = 
 * **+RIIR +INNAR** = 
 * **+RIIR +KATAP +RIIR +KATAP +SIMA** = 
 * **+RIIR +LIR +RIIR +LIR +SSA** = 
 * **+RIIR +LLAR** = 
 * **+RIIR +RIAR** = 
 * **+RIIR +SIMA +RIIR +SIMA +GALUAR +RIIR +SIMA +GUNAR +RIIR +SIMA +GUNAR +GALUAR +RIIR +SIMA +GUNAR +NNGIT +RIIR +SIMA +GUNAR +RIAR +RIIR +SIMA +HTR +RIIR +SIMA +LIR +RIIR +SIMA +LIR +RIAR +RIIR +SIMA +NIR +RIIR +SIMA +NNGIT +RIIR +SIMA +QQU +RIIR +SIMA +QQU +NIQAR +RIIR +SIMA +QQU +NIQAR +TAR +RIIR +SIMA +SSA +RIIR +SIMA +SSA +GALUAR +RIIR +SIMA +TSIAR +INNAR** = 
 * **+RIIR +SSA** = 
 * **+RIIR +TARIAQAR** = 
 * **+RIIR +TIGE** = 
 * **+RIIR +TIP +RIIR +TIP** = 
 * **+RIIR +VIP +RIIR +VIP +SIMA** = 
 * **+RIP** = 
 * **+RLAAQ** = 
 * **+RRAK** = 
 * **+RRATE** = 
 * **+RRATE +NGAAR** = 
 * **+RSUR** =  isumaliuutersuut   
 * **+RUJUK** = 
 * **+RUJUK +SUAQ** = 
 * **+RUJUP +RUJUP +SUAR +RUJUP +SUAR +GALUAR +RUJUP +SUAR +GUSUP +RUJUP +SUAR +GUSUP +GALUAR +RUJUP +SUAR +INNAR +RUJUP +SUAR +NIAR +RUJUP +SUAR +NIKUU +RUJUP +SUAR +PALLAP +RUJUP +SUAR +QE +RUJUP +SUAR +QINA +RUJUP +SUAR +QQAAR +SIMA +RUJUP +SUAR +SIMA +RUJUP +SUAR +SSA +RUJUP +SUAR +SSA +GALUAR +RUJUP +SUAR +TAR +RUJUP +SUAR +TAR +NIAR +RUJUP +SUAR +TARIAQAR** = 
 * **+RUJUUR** = 
 * **+RUJUUR +LIR** = 
 * **+RUJUUR +NIAR** = 
 * **+RUJUUR +SIMA** = 
 * **+RUJUUR +SIMAAR +RUJUUR +SIMAAR +TIP** = 
 * **+RUJUUR +SSA** = 
 * **+RUJUUR +TAR +RUJUUR +TAR +SSA** = 
 * **+RUJUUR +TIP +LIR** = 
 * **+RUJUUR +UTIGE** = 
 * **+RUJUURUTAA** = 
 * **+RULUP** = 
 * **+RULUUR +RULUUR +RIAR +RULUUR +SIMA +RULUUR +SIMA +NIR** = 
 * **+RULUUR +TAR +RULUUR +TAR +SIMA +RULUUR +TAR +SIMA +QE** = 
 * **+RULUUR +TARE** = 
 * **+RUSAAR** = 
 * **+RUSAAR +INNAR** = 
 * **+RUSAAR +LIR +RUSAAR +LIR +SSA** = 
 * **+RUSAAR +NIAR** = 
 * **+RUSAAR +NNGIT** = 
 * **+RUSAAR +QQAAR +RUSAAR +QQAAR +TAR +RUSAAR +QQAAR +TARIAQAR +RUSAAR +QQAAR +TARIAQAR +TAR** = 
 * **+RUSAAR +TAR** = 
 * **+RUSAAR +TIP** = 
 * **+RUSAAR +TUAR +RUSAR +TUAR +GALUAR +RUSAAR +TUAR +INNAR +RUSAAR +TUAR +NIKUU +RUSAAR +TUAR +PASIP +RUSAAR +TUAR +SIMA +RUSAAR +TUAR +SINNAR** = 
 * **+RUSAAR +UTIGE** = 
 * **+RUSAQ** = 
 * **+RUTTUR** = 
 * **+RUTTUR +LIR** = 
 ...
 * **+RUUSAAR +NNGIT** = 
 * **+SAAR +SAAR +HTR** = 
 * **+SAAR +LLUAR +SAAR +LLUAR +LAAR +SAAR +LLUAR +LIR +SAAR +LLUAR +LIR +RIIR +SAAR +LLUAR +LIR +RIIR +QQU +SAAR +LLUAR +LIR +RIIR +QQU +GALUAR +SAAR +LLUAR +LIR +RUTTUR +SAAR +LLUAR +NAR +SAAR +LLUAR +NIAR +SAAR +LLUAR +NIRU +SAAR +LLUAR +NIRU +LIR +SAAR +LLUAR +NNGIT +SAAR +LLUAR +QATTAAR +SAAR +LLUAR +QATTAAR +LIR +SAAR +LLUAR +QE +SAAR +LLUAR +QISSAAR +SAAR +LLUAR +QQAAR +SAAR +LLUAR +QQU +SAAR +LLUAR +QQU +NIAR +SAAR +LLUAR +QQU +NIAR +LIR +SAAR +LLUAR +QQU +RIAR +SAAR +LLUAR +RIAR +SAAR +LLUAR +SSA +SAAR +LLUAR +SIMA +SAAR +LLUAR +SIMA +NNGIT +SAAR +LLUAR +SIMA +QE +SAAR +LLUAR +SINNAA +SAAR +LLUAR +SINNAA +GUNNAIR +SAAR +LLUAR +SINNAA +LIR +SAAR +LLUAR +SINNAA +LIR +SIMA +SAAR +LLUAR +SINNAA +NNGIT +SAAR +LLUAR +SINNAA +SIMA +SAAR +LLUAR +SINNAA +SIMA +GALUAR +SAAR +LLUAR +TAR +SAAR +LLUAR +TARIAQAR +SAAR +LLUAR +TARIAQAR +TAR +SAAR +LLUAR +TIGE +SAAR +LLUAR +TIP +SAAR +LLUAR +TIP +RIIR +SAAR +LLUAR +VIP** = 
 * **+SAAR +NIAR +SAAR +NIAR +VIP** = 
 * **+SAAR +NNGIT +VIP** = 
 * **+SAAR +QE** = 
 * **+SAAR +RIIR +SAAR +RIIR +SIMA +SAAR +RIIR +SIMA +GALUAR** = 
 * **+SAAR +SINNAA** = 
 * **+SAAR +SINNAA +NNGIT** = 
 * **+SAAR +TIP** = 
 * **+SAAR +TUR** = 
 * **+SAAR +VALLAAR** = 
Der er gået rod i SI. Husk at -si- i tigusivoq etc. = tigu+HTR, og -si- i allagarsivoq er SI+nv. SI+vv er sjælden, og overgenererer   
oven i koebet saa voldsomt, jeg har problemer med disambigueringen. Jeg sletter hele SI+vv. De vigtigste verbalformer er allerede med i 
verb-kal.lex (taarsivoq, peqqissivoq, iluarsivoq, naammassivoq)   
 * **+SI** = 
 * **+SI +NAR** = 
 * **+SI +NAR +QE** = 
 * **+SIAQ** = 
 * **+SIAQ +INNAQ +SIAQ +INNAQ +MINIQ +SIAQ +INNAQ +NNGUAQ** = 
 * **+SIAQ +SSAQ +SIAQ +SSAQ +GALUAQ +SIAQ +SSAQ +MINIQ +SIAQ +SSAQ +SIAQ +SIAQ +SSAQ** = 
 * **+SII** = 
 * **+SILAT** = 
 * **+SIMA** = 
 * **+SIMA +GALUAR +SIMA +GALUAR +NIR** = 
 * **+SIMA +GUNAR +SIMA +GUNAR +GALUAR +SIMA +GUNAR +NIRAR +SIMA +GUNAR +NNGIT +SIMA +GUNAR +NNGIT +GALUAR +SIMA +GUNAR +NNGIT +VIP +SIMA +GUNAR +QE +SIMA +GUNAR +RIAR +SIMA +GUNAR +RUTTUR +SIMA +GUNAR +VIP** = 
 * **+SIMA +GUNNAIR +SIMA +GUNNAIR +QINA +SIMA +GUNNAIR +QQU** = 
 * **+SIMA +HTR** = 
 * **+SIMA +INNAR +SIMA +INNAR +GUSUP +GALUAR +SIMA +INNAR +RUNAR +SIMA +INNAR +SINNAA +SIMA +INNAR +SINNAA +NNGIT** = 
 * **+SIMA +KATAP +SIMA +KATAP +LIR +SIMA +KATAP +VIP** = 
 * **+SIMA +LAAR +RIAR** = 
 * **+SIMA +LIR +SIMA +LIR +GALUAR +SIMA +LIR +NIAR +SSA +SIMA +LIR +RIAR +SIMA +LIR +RIATAAR +SIMA +LIR +RIATAAR +TAR +SIMA +LIR +RIIR +SIMA +LIR +RUTTUR +SIMA +LIR +SSA +SIMA +LIR +SSA +GALUAR +SIMA +LIR +TAR +SIMA +LIR +TIP +SIMA +LIR +NIKUU +NNGIT +TAR +INNAR +GALUAR** = 
 * **+SIMA +LIRTUR +SIMA +LIRTUR +RIAR** = 
 * **+SIMA +LLUAR** = 
 * **+SIMA +LLUINNAR** = 
 * **+SIMA +NAR +SIMA +NAR +GALLAR +SIMA +NAR +GALUAR +SIMA +NAR +GUNAR +SIMA +NAR +GUNNAIR +SIMA +NAR +KUJUP +SIMA +NAR +LAAR +SIMA +NAR +LLUINNAR +SIMA +NAR +NAAR +SIMA +NAR +NAVIAR +NNGIT +SIMA +NAR +NGAAR +SIMA +NAR +NIKUU +SIMA +NAR +NIRAR +SIMA +NAR +NIRU +SIMA +NAR +NNGIT +SIMA +NAR +PALUP +SIMA +NAR +PASIP +SIMA +NAR +PIAR +NNGIT +SIMA +NAR +TIP +SIMA +NAR +VALLAAR +NNGIT** = 
 * **+SIMA +NAVIAR +NNGIT +SIMA +NAVIAR +NNGIT +GALUAR** = 
 * **+SIMA +NGAAR +SIMA +NGAAR +TSIAR +SIMA +NGAAR +TSIAR +RIIR** = 
 * **+SIMA +NIAR +SIMA +NIAR +TAR +SIMA +NIAR +TARE +INNAR +SIMA +NIAR +TARE +INNAR +NIAR +SIMA +NIAR +TARE +INNAR +RIAR +SIMA +NIAR +TARE +INNAR +SSA +SIMA +NIAR +VISSUR** = 
 * **+SIMA +NIQAR +SIMA +NIQAR +TARIAQAR +SIMA +NIQAR +TARIAQAR +GALUAR** = 
 * **+SIMA +NIR** = 
 * **+SIMA +NIRAR +SIMA +NIRAR +NIQAR** = 
 * **+SIMA +NNGISAANNAR** = 
 * **+SIMA +NNGIT +SIMA +NNGIT +GALLAR +SIMA +NNGIT +GALLAR +TIP +SIMA +NNGIT +GALUAR +SIMA +NNGIT +INNAR +SIMA +NNGIT +INNAR +NIR +SIMA +NNGIT +INNAR +SIMA +SIMA +NNGIT +LLUINNAR +SIMA +NNGIT +NIR +SIMA +NNGIT +RIIR** = 
 * **+SIMA +NNGIT +TIP +SIMA +NNGIT +TIP +HTR +SIMA +NNGIT +VIP** = 
 * **+SIMA +NNGISAANNAR +SIMA +NNGISAANNAR +GALUAR +SIMA +NNGISAANNAR +SIMA** = 
 * **+SIMA +NNGUAR +KASIP** = 
 * **+SIMA +NNGUATSIAR** = 
 * **+SIMA +PALAAR +SIMA +PALAAR +RIIR +TIGE +SIMA +PALAAR +TIGE** = 
 * **+SIMA +PALUP +SIMA +PALUP +LAAR +SIMA +PALUP +LAAR +RIAR** = 
 * **+SIMA +PASIP +SIMA +PASIP +GALUAR +SIMA +PASIP +TAR** = 
 * **+SIMA +QE** = 
 * **+SIMA +QINA** = 
 * **+SIMA +QQIP +SIMA +QQIP +LIR** = 
 * **+SIMA +QQU +SIMA +QQU +NNGIT** = 
 * **+SIMA +RATAR +SINNAA** = 
 * **+SIMA +RIAR** = 
 * **+SIMA +RIIR** = 
 * **+SIMA +RUSAAR** = 
 * **+SIMA +RUUSAAR** = 
 * **+SIMA +SINNAA +SIMA +SINNAA +GALUAR +SIMA +SINNAA +GUMA +SIMA +SINNAA +NIR +SIMA +SINNAA +NNGIT +SIMA +SINNAA +QQU** = 
 * **+SIMA +SSA +SIMA +SSA +GALUAR +SIMA +SSA +GUNAR +SIMA +SSA +NNGIT +SIMA +SSA +NNGIT +GALUAR** = 
 * **+SIMA +TARE** = 
 * **+SIMA +TARIAQAR +SIMA +TARIAQAR +GUNAR +SIMA +TARIAQAR +GUNAR +GALUAR** = 
 * **+SIMA +TAR +SIMA +TAR +SSA** = 
 * **+SIMA +TIGE +SIMA +TIGE +NNGIT** = 
 * **+SIMA +TIP +SIMA +TIP +HTR +SIMA +TIP +INNAR +NIAR +GUNAR +SIMA +TIP +INNAR +GUMA +SIMA +TIP +NIAR +TAR +SIMA +SIMA +TIP +NIQAR +SIMA +TIP +SSA** = 
 * **+SIMA +TIP +TUAR +SIMA +TIP +TUAR +GALUAR +SIMA +TIP +TUAR +GUMAAR +SIMA +TIP +TUAR +GUNAR +SIMA +TIP +TUAR +GUNNAR +SIMA +TIP +TUAR +INNAR +SIMA +TIP +TUAR +KANNIR +SIMA +TIP +TUAR +LLUINNAR +SIMA +TIP +TUAR +NIKUU +SIMA +TIP +TUAR +NNGUATSIAR +SIMA +TIP +TUAR +PALUP +SIMA +TIP +TUAR +PASIP +SIMA +TIP +TUAR +SINNAA +SIMA +TIP +TUAR +SINNAR +SIMA +TIP +TUAR +SSA +SIMA +TIP +TUAR +LIR +SIMA +TIP +TUAR +LIR +GALUAR +SIMA +TIP +TUAR +LIR +GUMAAR +SIMA +TIP +TUAR +LIR +GUNAR +SIMA +TIP +TUAR +LIR +NIKUU +SIMA +TIP +TUAR +LIR +NNGUATSIAR +SIMA +TIP +TUAR +LIR +PAJAAR +SIMA +TIP +TUAR +LIR +PALUP +SIMA +TIP +TUAR +LIR +PASIP +SIMA +TIP +TUAR +LIR +SINNAA +SIMA +TIP +TUAR +LIR +SINNAR +SIMA +TIP +TUAR +LIR +SSA** = 
 * **+SIMA +TSIAR +SIMA +TSIAR +INNAR +SIMA +TSIAR +RIAR +SIMA +TSIAR +RIIR** = 
 * **+SIMA +TUAR +SIMA +TUAR +GALUAR +SIMA +TUAR +GUMA +SIMA +TUAR +INNAR +SIMA +TUAR +NIAR** = 
 * **+SIMA +TUQ +KASSAK +U** = 
 * **+SIMA +VALLAAR +SIMA +VALLAAR +NNGIT** = 
 * **+SIMA +VIP** = 
 * **+SIMAAR** = 
 * **+SIMAAR +INNAR** = 
 * **+SIMAAR +LLUAR** = 
 * **+SIMAAR +LLUINNAR** = 
 * **+SIMAAR +LAAR +SIMAAR +LAAR +LIR +SIMAAR +LAAR +LIR +VIP +SIMAAR +LAAR +VIP** = 
 * **+SIMAAR +NAR** = 
 * **+SIMAAR +NIQAR +SIMAAR +NIQAR +TUAR +SIMAAR +NIQAR +TUAR +TAR** = 
 * **+SIMAAR +PALAAR** = 
 * **+SIMAAR +PALUP** = 
 * **+SIMAAR +PASIP +SIMAAR +PASIP +GUNNAIR +SIMAAR +PASIP +GUNNAIR +RIAR +SIMAAR +PASIP +LLUINNAR +SIMAAR +PASIP +LLUINNAR +GALUAR +SIMAAR +PASIP +NNGIT +SIMAAR +PASIP +NNGIT +LLUINNAR +SIMAAR +PASIP +NNGIT +LLUINNAR +TAR +SIMAAR +PASIP +NNGIT +VIP +SIMAAR +PASIP +NNGIT +VIP +TAR +SIMAAR +PASIP +QE +SIMAAR +PASIP +RIAR +SIMAAR +PASIP +TAR +SIMAAR +PASIP +TUAR +SIMAAR +PASIP +TUAR +INNAR** = 
 * **+SIMAAR +QQAAR +LAAR** = 
 * **+SIMAAR +RUUSAAR** = 
 * **+SIMAAR +SINNAA +LIR +SIMA** = 
 * **+SIMAAR +TAR +SIMAAR +TAR +NNGIT** = 
 * **+SIMAAR +TIGE** = 
 * **+SIMAAR +TUAR** = 
 * **+SIMAAR +VALLAAR +SIMAAR +VALLAAR +GUNNAIR SIMAAR=VALLAAR=LIR +SIMAAR +VALLAAR +NNGIT +SIMAAR +VALLAAR +VIP** = 
 * **+SIMAAR +VIP** = 
 * **+SINNAA** = 
 * **+SINNAA +GALUAR** = 
 * **+SINNAA +GUMA** = 
 * **+SINNAA +GUMAAR** = 
 * **+SINNAA +GUNAR +SINNAA +GUNAR +NNGIT** = 
 * **+SINNAA +GUNNAIR +SINNAA +GUNNAIR +LIR +SINNAA +GUNNAIR +NIRAR +SINNAA +GUNNAIR +PAJAAR +SINNAA +GUNNAIR +QQA +SINNAA +GUNNAIR +SSA +SINNAA +GUNNAIR +TAR +SINNAA +GUNNAIR +TAR +GALUAR +SINNAA +GUNNAIR +TAR +NIR +SINNAA +GUNNAIR +TAR +SIMA +SINNAA +GUNNAIR +TIP +SINNAA +GUNNAIR +TIP +NIQAR** = 
 * **+SINNAA +LIR +SINNAA +LIR +RIIR +SINNAA +LIR +NAVIAR +NNGIT +SINNAA +LIR +QQU +SINNAA +LIR +SIMA +SINNAA +LIR +SSA +SINNAA +LIR +TAR +SINNAA +LIR +TIP** = 
 * **+SINNAA +LLUAR +SINNAA +LLUAR +SSA** = 
 * **+SINNAA +NAVIAR +NNGIT +SINNAA +NAVIAR +NNGIT +GALUAR** = 
 * **+SINNAA +NIAR +SSA** = 
 * **+SINNAA +NIR** = 
 * **+SINNAA +NIRAR** = 
 * **+SINNAA +NNGIT +SINNAA +NNGIT +GALUAR +SINNAA +NNGIT +LUINNAR +SINNAA +NNGIT +NIR +SINNAA +NNGIT +NIRAR +SINNAA +NNGIT +VIP** = 
 * **+SINNAA +NNGISAANNAR** = 
 * **+SINNAA +NNGUATSIAR** = 
 * **+SINNAANNGUR +SINNAANNGUR +GUMAAR +SINNAANNGUR +TIP** = 
 * **+SINNAA +PIAR +NNGIT** = 
 * **+SINNAA +QQU** = 
 * **+SINNAA +SIMA +SINNAA +SIMA +GALUAR +SINNAA +SIMA +GUNAR +SINNAA +SIMA +NAVIAR +NNGIT +SINNAA +SIMA +NIR +SINNAA +SIMA +NNGIT +SINNAA +SIMA +NNGIT +NIR** = 
 * **+SINNAA +SSA +SINNAA +SSA +GALUAR +SINNAA +SSA +NIR +SINNAA +SSA +NNGIT** = 
 * **+SINNAA +TARIAQAR** = 
 * **+SINNAA +TAR +NNGIT +SINNAA +TAR +SIMA +SINNAA +TAR +SIMA +NNGIT** = 
 * **+SINNAA +TIP** = 
 * **+SINNAA +TUAR** = 
 * **+SINNAA +TUQ +U +SINNAA +TUQ +U +GALUAR** = 
 * **+SINNAAQ** = 
 * **+SINNAR** = 
 * **+SIR** = 
 * **+SIUR** = 
 * **+SIUT +SIUT +LIK +SIUT +PAK +SUAQ +SIUT +SSAQ** = 
 * **+SSA** = 
 * **+SSA +GALUAR** = 
 * **+SSA +GUNAR +SSA +GUNAR +GALUAR** = 
 * **+SSA +GUNNAR +SI** = 
 * **+SSA +NGA +SSA +NGA +NAR +SSA +NGA +NAR +NIRU +SSA +NGA +NAR +NIRU +TAR +SSA +NGA +NNGIT +SSA +NGA +NNGIT +GALUAR +SSA +NGA +TIP +SSA +NGA +TIP +GUNNAAR +SSA +NGA +TIP +NIQAR** = 
 * **+SSA +NIR** = 
 * **+SSA +NIRAR** = 
 * **+SSA +NNGIT +SSA +NNGIT +GALUAR +SSA +NNGIT +LUINNAR +SSA +NNGIT +NIR** = 
 * **+SSA +QE +SSA +QE +NIR** = 
 * **+SSA +QQAAR** = 
 * **+SSA +SIMA** = 
 * **+SSA +TIP** = 
 ...
 * **+SSAAR +SSAAR +NNGIT** = 
 * **+SSAAR +TAR** = 
 * **+SSAAR +VIP +SSAAR +VIP +SUR** = 
 * **+SSAMAAQ** = 
 * **+SSAMAAR** = 
 * **+SSAMAAR +LIR +RIIR +SIMA** = 
 * **+SSAMAAR +RUTTUR** = 
 * **+SSAMAAR +QE** = 
 * **+SSAQ +SSAQ +GALUAQ +SSAQ +INNAQ +SSAQ +LIAQ +SSAQ +MINIQ +SSAQ +SIAQ +SSAQ +SIAQ +KKAAQ +SSAQ +PAK +SSAQ +PAK +SUAQ +SSAQ +PAK +SUAQ +LIK +SSAQ +RUJUK +SUAQ +SSAQ +SIAQ +SSAQ** = 
 * **+SSAQ +SUAQ +SSAQ +TAAQ +SSAQ +TAQ +SSAQ +TUAQ +SSAQ +TUAQ +NNGUAQ** = 
 * **+SSAQQIP** = 
 * **+SSI** = 
 * **+SSIP** = 
 * **+SSUSIQ +SSUSIQ +ARAQ +KASIK** = 
 * **+SUAQ +SUAQ +ARAQ +SUAQ +ARAQ +KASIK +SUAQ +KKUT +SUAQ +LIAQ +RUJUK +SUAQ +SUAQ +USAQ +SUAQ +USAAQ +SUAQ +USAQ +SUAQ +SUAQ +USAAQ +SUAQ** = 
 * **+SUAR** = 
 * **+SUATAAR** = 
 * **+SUNNI** = 
 * **+SUNNIP** = 
 * **+SURE** = 
 * **+SURE +NAR +SURE +NAR +SI +SURE +NAR +SI +SIMA +SURE +NAR +TAR +SURE +NAR +TAR +GALUAR** = 
 * **+SURE +NIQAR** = 
 * **+SURE +NIR** = 
 * **+SURE +NNGIT +SURE +NNGIT +GALUAR** = 
 * **+SURE** = 
 * **+T** =  kun sammen med NIAR -> qimmerniartoq, tuttunniartoq   
 * **+TAR** = 
 * **+TAAQ +TAAQ +SUAQ** = 
 * **+TAAR** =   Baade vv og nv.   
 * **+TAQ +TAQ +GALUAQ +TAQ +LIK +TAQ +NNGUAQ +TAQ +PAK +TAQ +PAK +SSUAQ +TAQ +TUAQ** = 
 * **+TAR** = 
 * **+TAR +GALLAR** = 
 * **+TAR +GALUAR +TAR +GALUAR +QE** = 
 * **+TAR +GUMAAR** = 
 * **+TAR +GUNNAIR** = 
 * **+TAR +GUSUP +TAR +GUSUP +GALUAR +TAR +GUSUP +GALUAR +TAR +GUSUP +NIR +TAR +GUSUP +SIMA +TAR +GUSUP +SIMA +GALUAR +TAR +GUSUP +SIMA +NNGIT +TAR +GUSUP +SINNAA +TAR +GUSUP +SINNAA +NNGIT +TAR +GUSUP +SINNAA +GALUAR +TAR +GUSUP +SINNAA +GUNAR +TAR +GUSUP +SINNAA +GUNAR +GALUAR +TAR +GUSUP +SINNAA +TAR** = 
 * **+TAR +INNAR** = 
 * **+TAR +LAAR +TAR +LAAR +RIAR** = 
 * **+TAR +LIR +TAR +LIR +GUMAAR +TAR +LIR +QQAAR +TAR +LIR +RIAR +TAR +LIR +RIIR +TAR +LIR +SIMA +TAR +LIR +SIMA +NIR +TAR +LIR +SSA +TAR +LIR +SSA +NNGIT +TAR +LIR +TIP** = 
 * **+TAR +NIAR +TAR +NIAR +GUMAAR +TAR +NIAR +SSA** = 
 * **+TAR +NIKUU +TAR +NIKUU +NNGIT** = 
 * **+TAR +NIQAR +TAR +NIQAR +SSA** = 
 * **+TAR +NIR** = 
 * **+TAR +NNGIT** = 
 * **+TAR +QATTAAR +TAR +QATTAAR +NNGIT +TAR +QATTAAR +NNGIT +GALUAR +TAR +QATTAAR +NNGIT +TUUR +TAR +QATTAAR +SIMA +TAR +QATTAAR +TARIAQAR +TAR +QATTAAR +TARIAQAR +TAR +TAR +QATTAAR +TUAR +TAR +QATTAAR +TUAR +TARIAQAR +TAR +TAR +QATTAAR +UTE +TAR +QATTAAR +UTIGE** = 
 * **+TAR +QE** = 
 * **+TAR +QQU +TAR +QQU +HTR** = 
 * **+TAR +RIAR** = 
 * **+TAR +RIIR +TAR +RIIR +SIMA +TAR +RIIR +SIMA +GUNAR** = 
 * **+TAR +SIMA +TAR +SIMA +GALUAR +TAR +SIMA +NIR +TAR +SIMA +NNGIT +TAR +SIMA +NNGIT +NIR +TAR +SIMA +QE +TAR +SIMA +SSA +TAR +SIMA +SSA +GALUAR +TAR +SIMA +SSA +GUNNAR +SI +TAR +SIMA +SSA +NGA +TIP +TAR +SIMA +SSA +NGA +TIP +NNGIT +TAR +SIMA +SSA +NGA +TIP +NIQAR +TAR +SIMA +SSA +NIR +TAR +SIMA +SSA +NIRAR +TAR +SIMA +SSA +NNGIT +TAR +SIMA +SSA +NNGIT +NIRAR +TAR +SIMA +SSA +NNGIT +GALUAR +TAR +SIMA +SSA +NNGIT +LUINNAR +TAR +SIMA +SSA +NNGIT +NIR +TAR +SIMA +SSA +QQAAR +TAR +SIMA +SSA +QE +TAR +SIMA +SSA +SIMA +TAR +SIMA +SSA +GUNAR +TAR +SIMA +SSA +NIR +TAR +SIMA +TAR +TAR +SIMA +TIGE +TAR +SIMA +TIGE +GALUAR** = 
 * **+TAR +SINNAA +TAR +SINNAA +GALUAR +TAR +SINNAA +GUNAR +TAR +SINNAA +GUNAR +GALUAR +TAR +SINNAA +NNGIT +TAR +SINNAA +QQU +TAR +SINNAA +SIMA +TAR +SINNAA +SIMA +GALUAR +TAR +SINNAA +SIMA +NNGIT** = 
 * **+TAR +SSA +TAR +SSA +NNGIT +TAR +SSA +NNGIT +GALUAR +TAR +SSA +QE** = 
 * **+TAR +TAR** = 
 * **+TAR +TURUJUSSUU** =  PL 20180131 rettet i morf-lexemer og her   
 * **+TARE** = 
 * **+TARIAQ** = 
 * **+TARIAQAR** = 
 * **+TARIAQAR +GALUAR** = 
 * **+TARIAQAR +LIR +TARIAQAR +LIR +SIMA +TARIAQAR +LIR +SINNAA TARIAQAR=LLUAR** = 
 * **+TARIAQAR +NIRAR** = 
 * **+TARIAQAR +NIRU** = 
 * **+TARIAQAR +NNGIT +TARIAQAR +NNGIT +NIR** = 
 * **+TARIAQAR +SIMA +TARIAQAR +SIMA +GUNAR** = 
 * **+TARIAQAR +SSA +TARIAQAR +SSA +GALUAR +TARIAQAR +SSA +NIR +TARIAQAR +SSA +NNGIT** = 
 * **+TARIAQAR +TAR** = 
 * **+TARIAQAR +TIP +TARIAQAR +TIP +HTR** = 
 * **+TARIAARUTE** =  tilføjet som samlet vv fordi TARIAQ+vn+IRUTE+nv problematisk for CG   
 * **+TE** = 
 * **+TIGE** = 
 * **+TIGE +GALUAR** = 
 * **+TIGE +INNAR +TIGE +INNAR +GALUAR +TIGE +INNAR +GALUAR +RIAR +TIGE +INNAR +GUSUP +TIGE +INNAR +GUSUP +GALUAR +TIGE +INNAR +LIR +TIGE +INNAR +LIR +SSA +TIGE +INNAR +NGAJAP +TIGE +INNAR +NGAJAP +TAR +TIGE +INNAR +NIAR +TIGE +INNAR +NNGIT +TIGE +INNAR +NNGIT +NIR +TIGE +INNAR +QE +TIGE +INNAR +QQAAR +TIGE +INNAR +SIMA +TIGE +INNAR +SINNAA +TIGE +INNAR +SSA +TIGE +INNAR +TAR +TIGE +INNAR +TARIAQAR +TIGE +INNAR +TARIAQAR +TAR +TIGE +INNAR +VIP +TIGE +INNAR +VIP +TAR +TIGE +INNAR +VIP +TAR +SIMA** = 
 * **+TIGE +LIR +TIGE +LIR +SIMA +TIGE +LIR +TIP** = 
 * **+TIGE +LLUINNAR** = 
 * **+TIGE +NGAJAP** = 
 * **+TIGE +NIR** = 
 * **+TIGE +NNGIT** = 
 * **+TIGE +SIMA** = 
 * **+TIGE +SSA +TIGE +SSA +GALUAR +TIGE +SSA +NIR** = 
 * **+TIGE +TAR** = 
 * **+TIP** = 
 * **+TIP +ALLAP +TIP +ALLAP +NGAAR** = 
 * **+TIP +GALLAR** = 
 * **+TIP +GALUAR** = 
 * **+TIP +GALUTTUAR +INNAR +TIP +GALUTTUAR +INNAR +SIMA** = 
 * **+TIP +GASUAR +TIP +GASUAR +NIAR** = 
 * **+TIP +GI** = 
 * **+TIP +GIARTUR +TIP +GIARTUR +GALUAR +TIP +GIARTUR +INNAR +TIP +GIARTUR +NIAR +TIP +GIARTUR +SSA +TIP +GIARTUR +SSA +NNGIT +TIP +GIARTUR +SSA +NNGIT +NIR** = 
 * **+TIP +GUMA +TIP +GUMA +LLAARE +TIP +GUMA +NNGIT +TIP +GUMA +NNGIT +LLUINNAR +SURE +NAR +TIP +GUMA +NNGIT +NIR +TIP +GUMA +SIMA** = 
 * **+TIP +GUMA +TAR** = 
 * **+TIP +GUMINAR +TIP +GUMINAR +IT +TIP +GUMINAR +IT +SIMA +TIP +GUMINAR +IT +SIMA +QE** = 
 * **+TIP +GUMAAR** = 
 * **+TIP +GUNNAIR +TIP +GUNNAIR +NIAR** = 
 * **+TIP +GUSUP +TIP +GUSUP +NNGIT +TIP +GUSUP +NNGIT +NIR** = 
 * **+TIP +HTR** = 
 * **+TIP +INNAR +TIP +INNAR +GUMA +TIP +INNAR +SSA +TIP +INNAR +TAR +TIP +INNAR +TAR +NNGIT +TIP +INNAR +TAR +NNGIT +NIR +TIP +INNAR +TAR +SIMA +TIP +INNAR +TARIAQAR +LIR** = 
 * **+TIP +LAAR +TIP +LAAR +INNAR +TIP +LAAR +INNAR +GUMA +TIP +LAAR +NNGUAR** = 
 * **+TIP +LIR +TIP +LIR +RIAR +TIP +LIR +SSA +TIP +LIR +TAR** = 
 * **+TIP +LLATTAAR +NIRU** = 
 * **+TIP +LLUAR +TIP +LLUAR +QQU +TIP +LLUAR +RUTTUR +TIP +LLUAR +SINNAA +TIP +LLUAR +SINNAA +LIR** = 
 * **+TIP +LUINNAR +TIP +LUINNAR +GUSUP +GALUAR +TIP +LUINNAR +LIR** =  +TIP +LUINNAR +LIR +TIP PL 20180131 slettet   
 * **+TIP +LUINNAR +SIMA +TIP +LUINNAR +SIMA +GALUAR +TIP +LUINNAR +SIMA +NNGIT +TIP +LUINNAR +SIMA +NNGIT +GALUAR +TIP +LUINNAR +SSA** = 
 * **+TIP +NAVIAR +NNGIT** = 
 * **+TIP +NAVIIRSAAR +TIP +NAVIIRSAAR +TAR +TIP +NAVIIRSAAR +TIP +INNAR +SSA** = 
 * **+TIP +NGAJAP +TIP +NGAJAP +LIR +TIP +NGAJAP +VIP** = 
 * **+TIP +NIAR +TIP +NIAR +GALUAR +TIP +NIAR +GUMA +TIP +NIAR +LIR +TIP +NIAR +NIQAR +TIP +NIAR +NIQAR +LIR** = 
 * **+TIP +NIAR +NIQAR +TAR +TIP +NIAR +QQU +TIP +NIAR +TAR +TIP +NIAR +TAR +SIMA +TIP +NIAR +TAR +SIMA +GALUAR +TIP +NIAR +TARE +TIP +NIAR +TAR +GUMAAR +TIP +NIAR +TARIAQAR +TIP +NIAR +TARIAQAR +LIR +TIP +NIAR +TARIAQAR +NNGIT** = 
 * **+TIP +NIKUU +TIP +NIKUU +GALUAR +TIP +NIKUU +GUNAR +TIP +NIKUU +NNGIT +TIP +NIKUU +SIMA** = 
 * **+TIP +NIQAR +TIP +NIQAR +GALUAR +TIP +NIQAR +GIARTUAAR +LIR +TIP +NIQAR +LAAR +TIP +NIQAR +LAAR +GALUAR +TIP +NIQAR +LAAR +TAR +TIP +NIQAR +LAAR +TAR +GALUAR +TIP +NIQAR +LIR +TIP +NIQAR +LLUAR +TIP +NIQAR +NIKUU +TIP +NIQAR +NNGIT +TIP +NIQAR +QATTAAR +RATAR +SINNAA +SSA +TIP +NIQAR +QQU +NNGIT +GALUAR** = 
 * **+TIP +NIQAR +RIIR +TIP +NIQAR +SIMA +TIP +NIQAR +SINNAA +TIP +NIQAR +SINNAA +LIR +TIP +NIQAR +SINNAA +LIR +SSA +TIP +NIQAR +SINNAA +SSA +TIP +NIQAR +SINNAA +SSA +NNGIT +TIP +NIQAR +SSA +TIP +NIQAR +SSA +NNGIT +TIP +NIQAR +TAR +TIP +NIQAR +TARIAQAR +TIP +NIQAR +TARIAQAR +GALUAR** = 
 * **+TIP +NIRU +TIP +NIRU +LIR +TIP +NIRU +LIR +SIMA** = 
 * **+TIP +NNGIT +TIP +NNGIT +GALLAR +SSA +TIP +NNGIT +GALUAR +TIP +NNGIT +NGAJAP +SIMA +TIP +NNGIT +SSA +TIP +NNGIT +TUUR +TIP +NNGIT +TARE +INNAR** = 
 * **+TIP +PALLAP +TIP +PALLAP +GUNAR +TIP +PALLAP +SIMA +TIP +PALLAP +SIMA +SSA** = 
 * **+TIP +QATTAAR +TIP +QATTAAR +GALUAR +TIP +QATTAAR +GUNAR +TIP +QATTAAR +GUNNAIR +TIP +QATTAAR +GUSUP +TIP +QATTAAR +INNAR +TIP +QATTAAR +KATAP +TIP +QATTAAR +LIR +TIP +QATTAAR +NIAR +TIP +QATTAAR +NIKUU +TIP +QATTAAR +QQAAR +TIP +QATTAAR +RIAR +TIP +QATTAAR +RIIR +TIP +QATTAAR +SIMA +TIP +QATTAAR +SINNAA +TIP +QATTAAR +SSA +TIP +QATTAAR +TAR +TIP +QATTAAR +TUAR +TIP +QATTAAR +TUUR** = 
 * **+TIP +QINA** = 
 * **+TIP +QQA** = 
 * **+TIP +QQAAR +TIP +QQAAR +NIAR +TIP +QQAAR +QQAMMIR** = 
 * **+TIP +QQAMMIR** = 
 * **+TIP +QQIP** = 
 * **+TIP +QQIP +NIAR +TIP +QQIP +NIAR +GALLAR +TIP +QQIP +NIAR +GALUAR +TIP +QQIP +NIAR +GALUAR +GUMAAR +TIP +QQIP +NIAR +GUMA +TIP +QQIP +NIAR +GUMA +RIIR +TIP +QQIP +NIAR +GUMINAR +TIP +QQIP +NIAR +GUMINAR +IT +TIP +QQIP +NIAR +GUMINAR +IT +NIRAR +TIP +QQIP +NIAR +GUMINAR +IT +NIRU +TIP +QQIP +NIAR +GUMINAR +IT +NIRU +LIR +TIP +QQIP +NIAR +GUMINAR +IT +NIRU +LIR +TAR +TIP +QQIP +NIAR +GUNNAIR +TIP +QQIP +NIAR +GUSUP +TIP +QQIP +NIAR +INNAR +TIP +QQIP +NIAR +INNAR +GALUAR +TIP +QQIP +NIAR +INNAR +LIR +TIP +QQIP +NIAR +INNAR +SSA +TIP +QQIP +NIAR +INNAR +VIP +TIP +QQIP +NIAR +KUJUP +TIP +QQIP +NIAR +KUJUP +GALUAR +TIP +QQIP +NIAR +KUJUP +LIR +TIP +QQIP +NIAR +KUJUP +LIR +SIMA +TIP +QQIP +NIAR +KUJUP +LIR +SSA +TIP +QQIP +NIAR +KUJUP +SSA +TIP +QQIP +NIAR +KUJUP +TAR +TIP +QQIP +NIAR +LAAR +VIP +TIP +QQIP +NIAR +LIR +TIP +QQIP +NIAR +LIR +QE +TIP +QQIP +NIAR +NAR +TIP +QQIP +NIAR +NAVIAR +NNGIT +TIP +QQIP +NIAR +NGAAR +TIP +QQIP +NIAR +NIQAR +TIP +QQIP +NIAR +NIQAR +LIR +TIP +QQIP +NIAR +NIQAR +NIRU +TIP +QQIP +NIAR +NIQAR +NIRU +TAR +TIP +QQIP +NIAR +NIQAR +NNGIT +TUUR +NAVIAR +NNGIT +TIP +QQIP +NIAR +NIQAR +QQAAR +TAR +TIP +QQIP +NIAR +NIQAR +RIIR +TIP +QQIP +NIAR +NIQAR +SSA +TIP +QQIP +NIAR +NIQAR +SSA +NNGIT +TIP +QQIP +NIAR +NIQAR +TAR +TIP +QQIP +NIAR +NIQAR +TARIAQAR +TIP +QQIP +NIAR +NIQAR +TARIAQAR +NNGIT +TIP +QQIP +NIAR +NIQAR +VALLAAR +TIP +QQIP +NIAR +NIRU +TIP +QQIP +NIAR +NIRU +LIR +TIP +QQIP +NIAR +NIRU +TAR +TIP +QQIP +NIAR +NNGIT +TIP +QQIP +NIAR +NNGIT +GALUAR +TIP +QQIP +NIAR +NNGIT +NIR +TIP +QQIP +NIAR +NNGIT +QE +TIP +QQIP +NIAR +PILUP +TIP +QQIP +NIAR +QE +TIP +QQIP +NIAR +QQAAR +TIP +QQIP +NIAR +QQAAR +NNGIT +TIP +QQIP +NIAR +QQAAR +NNGIT +VIP +TIP +QQIP +NIAR +QQAAR +SSA +TIP +QQIP +NIAR +QQU +TIP +QQIP +NIAR +QQU +SSA +TIP +QQIP +NIAR +RIAR +TIP +QQIP +NIAR +RRATE +NGAAR +TIP +QQIP +NIAR +SIMA +TIP +QQIP +NIAR +SIMA +GALUAR +TIP +QQIP +NIAR +SIMA +NIR +TIP +QQIP +NIAR +SIMA +NNGIT +TIP +QQIP +NIAR +SIMA +NNGIT +NIR +TIP +QQIP +NIAR +SINNAA +TIP +QQIP +NIAR +SINNAA +NNGIT +TIP +QQIP +NIAR +SSA +TIP +QQIP +NIAR +SSA +GALUAR +TIP +QQIP +NIAR +SSA +NIR +TIP +QQIP +NIAR +SSA +NNGIT +TIP +QQIP +NIAR +SSA +NNGIT +NIR +TIP +QQIP +NIAR +TARE +TIP +QQIP +NIAR +TARE +GALUAR +TIP +QQIP +NIAR +TARE +GALUAR +RIAR +TIP +QQIP +NIAR +TARE +GUMAAR +TIP +QQIP +NIAR +TARE +INNAR +TIP +QQIP +NIAR +TARE +INNAR +SSA +TIP +QQIP +NIAR +TARE +LAAR +TIP +QQIP +NIAR +TARE +LIR +TIP +QQIP +NIAR +TARE +LIR +GUMA +TIP +QQIP +NIAR +TARE +NIAR +TIP +QQIP +NIAR +TARE +NNGIT +TIP +QQIP +NIAR +TARE +SSA +TIP +QQIP +NIAR +TARE +SSA +NNGIT +TIP +QQIP +NIAR +TARE +TAR +TIP +QQIP +NIAR +TARE +TUAR +TIP +QQIP +NIAR +TARE +UTIGE +TIP +QQIP +NIAR +TARIAQAR +TIP +QQIP +NIAR +TARIAQAR +SIMA +TIP +QQIP +NIAR +TAR +TIP +QQIP +NIAR +TAR +GALUAR +TIP +QQIP +NIAR +TAR +GALUAR +SIMA +TIP +QQIP +NIAR +TAR +GALUAR +SIMA +NIR +TIP +QQIP +NIAR +TAR +GALUAR +SIMA +SSA +TIP +QQIP +NIAR +TAR +INNAR +TIP +QQIP +NIAR +TAR +SIMA +TIP +QQIP +NIAR +TAR +SIMA +GALUAR +TIP +QQIP +NIAR +TIGE +TIP +QQIP +NIAR +TIGE +GALUAR +TIP +QQIP +NIAR +TUAR +TIP +QQIP +NIAR +TUAR +GALUAR +TIP +QQIP +NIAR +TUAR +INNAR +TIP +QQIP +NIAR +TUAR +INNAR +NNGIT +TIP +QQIP +NIAR +TUAR +INNAR +NNGIT +GALUAR +TIP +QQIP +NIAR +TUAR +INNAR +TAR +TIP +QQIP +NIAR +TUAR +NIKUU +TIP +QQIP +NIAR +TUAR +NNGUATSIAR +TIP +QQIP +NIAR +TUAR +PALUP +TIP +QQIP +NIAR +TUAR +PASIP +TIP +QQIP +NIAR +TUAR +SIMA +TIP +QQIP +NIAR +TUAR +SIMA +GALUAR +TIP +QQIP +NIAR +TUAR +SINNAR +TIP +QQIP +NIAR +TUAR +SINNAA +TIP +QQIP +NIAR +TUAR +SINNAA +NNGIT +TIP +QQIP +NIAR +TUAR +SSA +TIP +QQIP +NIAR +TUAR +SSA +GUNAR +TIP +QQIP +NIAR +TUAR +SSA +NIR +TIP +QQIP +NIAR +TUAR +SSA +NNGIT +TIP +QQIP +NIAR +TUAR +TAR +TIP +QQIP +NIAR +TUAR +TAR +NNGIT +TIP +QQIP +NIAR +TUAR +TAR +SIMA +TIP +QQIP +NIAR +VALLAAR +TIP +QQIP +NIAR +VALLAAR +NIAR +TIP +QQIP +NIAR +VALLAAR +SIMA +TIP +QQIP +NIAR +VIP +TIP +QQIP +NIAR +VIP +TAR** = 
 * **+TIP +QQIP +SSA** = 
 * **+TIP +QQIP +TAR** = 
 * **+TIP +QQU** = 
 * **+TIP +RATAR +TIP +RATAR +SIMA +TIP +RATAR +SIMA +NIR +TIP +RATAR +SIMA +SINNAA +TIP +RATAR +SIMA +SINNAA +NIR +TIP +RATAR +SIMA +SINNAA +NNGIT +TIP +RATAR +SIMA +SINNAA +NNGIT +NIR** = 
 * **+TIP +RIAR** = 
 * **+TIP +RIIR +TIP +RIIR +KATAP +TIP +RIIR +KATAP +GALUAR +TIP +RIIR +KATAP +SIMA +TIP +RIIR +KATAP +SIMA +GALUAR +TIP +RIIR +RUTTUR +TIP +RIIR +SIMA +TIP +RIIR +SIMA +GALUAR** = 
 * **+TIP +RUJUP +SUAR** = 
 * **+TIP +RUTTUR +TIP +RUTTUR +SIMA** = 
 * **+TIP +SIMA +TIP +SIMA +GUNAR +TIP +SIMA +LIR +TIP +SIMA +NIR +TIP +SIMA +NNGIT +TIP +SIMA +SSA** = 
 * **+TIP +SINNAA +TIP +SINNAA +GALUAR +TIP +SINNAA +GUMA +TIP +SINNAA +LIR +TIP +SINNAA +LIR +SSA +TIP +SINNAA +LIR +TIP +TIP +SINNAA +NAVIAR +TIP +SINNAA +NAVIAR +NNGIT +TIP +SINNAA +NNGIT +TIP +SINNAA +NNGUR +TIP +SINNAA +NNGUR +SIMA +TIP +SINNAA +NNGUR +SSA +TIP +SINNAA +SSA** = 
 * **+TIP +SSA +TIP +SSA +NGA +TIP +SSA +NGA +NIKUU +TIP +SSA +NGA +NNGIT +TIP +SSA +NGA +NNGIT +RIAR +TIP +SSA +NIR +TIP +SSA +NNGIT +TIP +SSA +NNGIT +GALUAR +TIP +SSA +NNGIT +NIR** = 
 * **+TIP +TAR** = 
 * **+TIP +TAR +LIR +TIP +TAR +LIR +SSA** = 
 * **+TIP +TAR +QE** = 
 * **+TIP +TAR +SIMA +TIP +TAR +SIMA +SSA** = 
 * **+TIP +TAR +SSA** = 
 * **+TIP +TARIAQAR** = 
 * **+TIP +TSIAR** = 
 * **+TIP +TUAR +TIP +TUAR +GALUAR +TIP +TUAR +GASUAR +TIP +TUAR +GUMAAR +TIP +TUAR +GUNAR +TIP +TUAR +GUNNAR +TIP +TUAR +INNAR +TIP +TUAR +KANNIR +TIP +TUAR +LLAR +TIP +TUAR +LLUINNAR +TIP +TUAR +MISAAR +TIP +TUAR +NIKUU +TIP +TUAR +NNGUATSIAR +TIP +TUAR +PAJAAR +TIP +TUAR +PALUP +TIP +TUAR +PASIP +TIP +TUAR +QQAJAA +TIP +TUAR +SIMA +TIP +TUAR +SINNAA +TIP +TUAR +SINNAR +TIP +TUAR +SSA +TIP +TUAR +LIR +TIP +TUAR +LIR +GALUAR +TIP +TUAR +LIR +GASUAR +TIP +TUAR +LIR +GUMAAR +TIP +TUAR +LIR +GUNAR +TIP +TUAR +LIR +GUNNAR +TIP +TUAR +LIR +INNAR +TIP +TUAR +LIR +KANNIR +TIP +TUAR +LIR +LLAR +TIP +TUAR +LIR +LLUINNAR +TIP +TUAR +LIR +MISAAR +TIP +TUAR +LIR +NIKUU +TIP +TUAR +LIR +NNGUATSIAR +TIP +TUAR +LIR +PAJAAR +TIP +TUAR +LIR +PALUP +TIP +TUAR +LIR +PASIP +TIP +TUAR +LIR +QQAJAA +TIP +TUAR +LIR +SINNAA +TIP +TUAR +LIR +SINNAR +TIP +TUAR +LIR +SSA** = 
 * **+TIP +UTIGE** = 
 * **+TIP +VALLAAR** = 
 * **+TIP +VIP +TIP +VIP +SINNAA +TIP +VIP +TIP** = 
 * **+TIR** = 
 * **+TITAAR** = 
 * **+TITIR +SIMA** = 
 * **+TITIR +TITIR +HTR** = 
 * **+TSAALI +TSAALIUR** = 
 * **+TSAP +TSAP +LIR +TSAP +LIR +VIP +TSAP +LIR +VIP +SIMA** = 
 * **+TSIAQ** = 
 * **+TSIAQ +SUAQ** = 
 * **+TSIAR** = 
 * **+TSIAR +GALLAR** = 
 ...
 * **+TSIAR +QQU** = 
 * **+TSIAR +RIAR** = 
 * **+TSIAR +SIMA +TSIAR +SIMA +LIR** = 
 * **+TSIAR +SINNAA** = 
 * **+TSIAR +TAR** = 
 * **+TSIISAA** = 
 * **+TSIR** = 
 * **+TU** = 
 * **+TUAQ +TUAQ +NNGUAQ +TUAQ +SUAQ** = 
 * **+TUAR** = 
 * **+TUAR +GALUAR** = 
 * **+TUAR +GASUAR** = 
 * **+TUAR +GUMAAR** = 
 * **+TUAR +GUNAR** = 
 * **+TUAR +GUNNAR** = 
 * **+TUAR +INNAR +TUAR +INNAR +GUMAAR +TUAR +INNAR +NNGIT +TUAR +INNAR +NNGIT +GALUAR +TUAR +INNAR +NNGIT +GALUAR +LLAR +TUAR +INNAR +NNGIT +GALUAR +NGAAR +TUAR +INNAR +NNGIT +GALUAR +NIKUU +TUAR +INNAR +NNGIT +GALUAR +NIR +TUAR +INNAR +NNGIT +GALUAR +NIRAR +TUAR +INNAR +NNGIT +GALUAR +PALUP +TUAR +INNAR +NNGIT +GALUAR +RUTTUR +TUAR +INNAR +NNGIT +GALUAR +SIMA +TUAR +INNAR +NNGIT +GALUAR +SINNAA +TUAR +INNAR +NNGIT +GALUAR +SINNAR +TUAR +INNAR +SIMA +TUAR +INNAR +SSA +TUAR +INNAR +TAR +TUAR +INNAR +TARIAQAR +TUAR +INNAR +TARIAQAR +TAR** = 
 * **+TUAR +IT +TUAR +KANNIR** = 
 * **+TUAR +LAAR +TUAR +LAAR +NIAR** = 
 * **+TUAR +LIR +TUAR +LIR +GALUAR +TUAR +LIR +GASUAR +TUAR +LIR +GUMAAR +TUAR +LIR +GUNAR +TUAR +LIR +GUNNAR +TUAR +LIR +INNAR +TUAR +LIR +KANNIR +TUAR +LIR +LLAR +TUAR +LIR +LLUINNAR +TUAR +LIR +MISAAR** = 
 * **+TUAR +NIAR** = 
 * **+TUAR +LIR +NIKUU +TUAR +LIR +NNGUATSIAR +TUAR +LIR +PAJAAR +TUAR +LIR +PALUP +TUAR +LIR +PASIP +TUAR +LIR +QQAJAA +TUAR +LIR +SINNAR +TUAR +LIR +SINNAA +TUAR +LIR +SSA +TUAR +LLAR +TUAR +LLUINNAR +TUAR +MISAAR +TUAR +NIKUU +TUAR +NNGUATSIAR +TUAR +PAJAAR +TUAR +PALUP +TUAR +PASIP +TUAR +QQAJAA +TUAR +SIMA +TUAR +SIMA +GALUAR !TUAR=SINNAR = TUAR=INNAR iflg. Kleinschmidt** = 
 * **+TUAR +SINNAA +TUAR +SINNAA +NNGIT** = 
 * **+TUAR +SSA +TUAR +SSA +GUNAR +TUAR +SSA +NIR +TUAR +SSA +NNGIT** = 
 * **+TUAR +TAR +TUAR +TAR +LIR +TUAR +TAR +NNGIT +TUAR +TAR +SIMA** = 
 * **+TUAR +TIP** = 
 * **+TUATAAR** = 
 * **+TUGAQ** = 
 * **+TUQ** = 
 * **+TUARANNGUU** =   et ex i corpus (Ole Brandt) qanittuarannguuaa   
 * **+TUKASSAA** = 
 * **+TURSUU** = 
 * **+TURUJUSSUU** = 
 * **+TURUJUSSUUSIMA** = 
 ...
 * **+TURSUU** = 
 * **+TUU** = 
 * **+TUUSAAR** =    TUQ+vn USAAR+nv ved transitiver   
 * **+TUQAQ +TUQAQ +NNGUAQ +TUQAQ +SUAQ** = 
 * **+TUR** = 
 * **+TUUQ** = 
 * **+TUUR** = 
 * **+TUUR +GALUAR** = 
 ...
 * **+TUUR +LAAR** = 
 * **+TUUR +LIR** = 
 * **+TUUR +NAVIIRSAAR +TUUR +NAVIIRSAAR +TARIAQAR** = 
 * **+TUUR +NNGIT +TUUR +NNGIT +TUUR +TUUR +NNGIT +TUUR +NAR +TUUR +NNGIT +NNGIT +TUUR +NAR +TAR +TUUR +NNGIT +NNGIT +TUUR +NAR +TAR +NNGIT** = 
 * **+TUUR +QENA** = 
 * **+TUUR +QQAJAA +NAR +GALUAR** = 
 * **+TUUR +SIMA +TUUR +SIMA +GALUAR +TUUR +SIMA +GUNAR** = 
 * **+TUUR +SINNAA +TUUR +SINNAA +TAR** = 
 * **+TUUR +TAR +TUUR +TAR +LIR** = 
 * **+TUUR +TIP +TUUR +TIP +VIP** = 
 * **+TUUR +TUAR** = 
 * **+TUUR +UTE** = 
 * **+TUUSI +TUUSI +LIR** = 
 * **+UMA** =   som i siluttuumasoq. Se også +MA   
 * **+UMI +UMI +LAAR +UMI +LAAR +RIAR** = 
 * **+UMMI** = 
 * **+UMMIR +UMMIR +GALUAR +UMMIR +INNAR +UMMIR +NGAAR +UMMIR +QE +UMMIR +RUJUP +SUAR +UMMIR +RUJUP +SUAR +QE +UMMIR +RUJUP +SUAR +TAR** = 
 * **+UAAR** = 
 * **+UMMIR +SAAR +UMMIR +SIMA** = 
 * **+UMMIR +SIMA +NIR +UMMIR +SIMA +QE +UMMIR +TAR +UMMIR +TIP** = 
 * **+UR** =   verbalisering af terminalis   
 * **+URL** =  bruges ikke 20180408, men findes i url.lexc.   
 * **+USAAQ** = 
 * **+USAAR** = 
 * **+USAP** = 
 * **+USAQ +USAQ +NNGUAQ** = 
 * **+USAR +USAR +INNAR +USAR +RIAR** = 
 * **+UTE +UTE +SUAQ +UTE +TUQAQ +UTE +TUQAQ +PALAAQ +UTE +TUQAQ +RUJUK +UTE +TUQAQ +SSAQ +UTE +TUQAQ +SSAQ +GALUAQ +UTE +TUQAQ +SSAQ +INNAQ +UTE +TUQAQ +SSAQ +LIK +UTE +TUQAQ +SSAQ +MINIQ +UTE +TUQAQ +SSAQ +SIAQ +UTE +TUQAQ +SSAQ +SIAQ +SSAQ +UTE +TUQAQ +SSAQ +SUAQ +UTE +TUQAQ +SSAQ +TUAQ +UTE +TUQAQ +SSAQ +TUAQ +NNGUAQ +UTE +TUQAQ +SSAQ +TSIALAK +UTE +TUQAQ +SUAQ +UTE +TUQAQ +SUAQ +PALAAQ +UTE +TUQAQ +SUAQ +SSAQ** = 
 * **+UTIGE** = 
 * **+UTIGE +INNAR +UTIGE +INNAR +GALUAR +UTIGE +INNAR +GALUAR +RIAR +UTIGE +INNAR +GUSUP +UTIGE +INNAR +GUSUP +GALUAR +UTIGE +INNAR +LIR +UTIGE +INNAR +LIR +SSA +UTIGE +INNAR +NGAJAP +UTIGE +INNAR +NGAJAP +TAR +UTIGE +INNAR +NIAR +UTIGE +INNAR +NNGIT +UTIGE +INNAR +NNGIT +NIR +UTIGE +INNAR +QE +UTIGE +INNAR +QQAAR +UTIGE +INNAR +SIMA +UTIGE +INNAR +SINNAA +UTIGE +INNAR +SSA +UTIGE +INNAR +TAR +UTIGE +INNAR +TARIAQAR +UTIGE +INNAR +TARIAQAR +TAR +UTIGE +INNAR +VIP +UTIGE +INNAR +VIP +TAR +UTIGE +INNAR +VIP +TAR +SIMA** = 
 * **+UTIGE +LIR +UTIGE +LIR +GALUAR +UTIGE +LIR +GUMAAR +UTIGE +LIR +SIMA +UTIGE +LIR +SINNAA +UTIGE +LIR +SINNAA +GALUAR +UTIGE +LIR +SINNAA +NIR +UTIGE +LIR +SSA +UTIGE +LIR +SSA +GALUAR +UTIGE +LIR +TARIAQAR** = 
 * **+UTIGE +NIR** = 
 * **+UTIGE +QQISSAAR +UTIGE +QQISSAAR +NIAR +UTIGE +QQISSAAR +TARIAQAR +UTIGE +QQISSAAR +TARIAQAR +TAR** = 
 * **+UTIGE +SSA** = 
 * **+UTIGE +TAR** = 
 * **+U** =  +U +GALUAQ !+U +NIRAR !+U +SAAR !+U +TIGE   
 * **+VALLAAQ** = 
 * **+VALLAAR** = 
 * **+VALLAAR +GALUAR** = 
 * **+VALLAAR +GUNAR +VALLAAR +GUNAR +NNGIT** = 
 * **+VALLAAR +GUNNAIR +VALLAAR +GUNNAIR +SIMA** = 
 * **+VALLAAR +INNAR** = 
 * **+VALLAAR +KULA** = 
 * **+VALLAAR +KULAAR** = 
 * **+VALLAAR +LAAR** = 
 * **+VALLAAR +LIR +VALLAAR +LIR +GUMAAR +VALLAAR +LIR +NNGIT +VALLAAR +LIR +QE +VALLAAR +LIR +SIMA** = 
 * **+VALLAAR +NAVIAR +NNGIT** = 
 * **+VALLAAR +NAVIIR +SAAR** = 
 * **+VALLAAR +NGAJAP** = 
 * **+VALLAAR +NIAR +VALLAAR +NIAR +TAR** = 
 * **+VALLAAR +NIKUU** = 
 * **+VALLAAR +NIR** = 
 * **+VALLAAR +NIRAR** = 
 * **+VALLAAR +NNGIT +VALLAAR +NNGIT +GALLAR +VALLAAR +NNGIT +GALUAR +VALLAAR +NNGIT +GUNAR +VALLAAR +NNGIT +VIP** = 
 * **+VALLAAR +NNGUATSIAR** = 
 * **+VALLAAR +PALUP** = 
 * **+VALLAAR +PASIP** = 
 * **+VALLAAR +QE** = 
 * **+VALLAAR +QINA** = 
 * **+VALLAAR +QQU +NNGIT** = 
 * **+VALLAAR +RUJUP +SUAR +VALLAAR +RUJUP +SUAR +SIMA** = 
 * **+VALLAAR +SIMA +VALLAAR +SIMA +GUNAR +VALLAAR +SIMA +GUNAR +NNGIT +VALLAAR +SIMA +GUNAR +NNGIT +GALUAR +VALLAAR +SIMA +QE +VALLAAR +SIMA +SSA +NNGIT +GALUAR** = 
 * **+VALLAAR +SINNAA** = 
 * **+VALLAAR +SURE** = 
 * **+VALLAAR +SSA +VALLAAR +SSA +NNGIT +VALLAAR +SSA +QE** = 
 * **+VALLAAR +TAR +VALLAAR +TAR +QE** = 
 * **+VALLAAR +TIP** = 
 * **+VALLAAR +TUUR** = 
 * **+VIK** = 
 * **+VIP** = 
 ...
 * **+VIP +GALUAR** = 
 * **+VIP +GUMA** = 
 * **+VIP +GUNAR +VIP +GUNNAIR +VIP +GUSUP +VIP +LLAR +VIP +NIAR +VIP +NNGIT** = 
 * **+VIP +NNGISAANNAR** = 
 * **+VIP +NNGUATSIAR** = 
 * **+VIP +SIMA** = 
 * **+VIP +SINNAA +VIP +SINNAA +NNGIT** = 
 * **+VIP +SSA +VIP +SSA +NNGIT** = 
 * **+VIP +TAR** = 
 * **+VISSUR +VISSUR +NNGIT** = 
 * **+VVAARIK** = 
 * **+VVAARIP** = 
...
Derivativer   
 * **+AA +AASIINNGUUQ +AASIIT +AASIILLU +AAT +GUUQ +GUURUNA +LI +LIAA +LIAASIIT +LIGUUQ +LIMI +LISSAAQ +LIUKU +LIUKUA +LIUNA +LU +LUGUUQ +LUMI +LUMIAASIIT +LUUNNIILLI +LUUNNIILLU +LUUNNIIMMI +LUUNNIIT +LUSUUQ +MAA +MAANNA +MAANNAA +MAANNAAJUNA +MI +MIAASIINNGUUQ +MIAA +MIAASIIT +MI +GUUQ +MI +GUUQ +UNA +MI +LU +MITA +MITAAVA +MITAAVAMI +MITAAVAAKU +MITAAVAANA +TA +TAAVA +TTAAQ +TTAARLU +TTAARMI +UKU +UKUA +UNA** =  uiguutit annerit
